     ...
     const getDetail = () => {
          ...
          axios.get(`/checkout/${id}`, {
               ...
               .then(function (response) {
                    ...
                    setLat(response.data.checkout.lat);
                    setLong(response.data.checkout.long);
                    ...
                    <div className="mx-5 p-5 mt-5 bg-white rounded-lg h-auto shadow-md">
                         <div ref={ref} className="p-2">
                              ...
                              <div className="w-full grid grid-cols-2 gap-3 pb-5">
                                   ...
                                   <p className="text-sm">
                                        Order Coordinate : (Lat: {lat} - Long: {long})
                                   </p>
                                   <div>
                                        <p className="text-sm">Note : {note}</p>
                                        <img className="self-center h-16 w-16 mt-5" src={`${process.env.REACT_APP_HOST_HEROKU}${image}`} alt="img" />
                                   </div>
                              </div>
