...
function Dashboard(props) {
     ...
     const getDashboard = () => {
          ...
          axios.get(`/sales/dashboard/${sales_id}`, {
               headers: {
                    Authorization: `Bearer ${token}`,
               },
          })
     ...
     const getTrip = () => {
          ...
          axios.get(`/sales/trip-single-sales/${sales_id}`, {
               headers: {
                    Authorization: `Bearer ${token}`,
               },
          })
               .then((res) => {
                    ...
                    for (let i = 0; i < res.data.data.length; i++) {
                         if (res.data.data[i]?.trip?.apotik.lat && res.data.data[i]?.trip?.apotik.long) {
                              arrayTemp.push([
                                   res.data.data[i].id,
                                   //ini poin penting dalam filter nya
