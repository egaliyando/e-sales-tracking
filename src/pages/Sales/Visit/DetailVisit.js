...
function DetailVisit(props) {
     ...
     function handleDelete(id) {
          const token = localStorage.token;
          axios.delete(`/sales/cart-sales/${id}`, {
               headers: {
                    Authorization: `Bearer ${token}`,
               },
          })
     ...
     function handleDone() {
          ...
          return MySwal.fire({
               ...
               if (test === true) {
                    axios.post(`/sales/checkout/${checkout_id}`, formData, {
                         headers: {
                              Authorization: `Bearer ${token}`,
                         },
                    })
                                   ...
                                   <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                        ...
                                        <div className="relative p-3 flex-auto">
                                             <div className="w-64 bg-gray-200 p-3">
                                                  <input onChange={(e) => setImage(e.target.files[0])} className="focus:outline-none overflow-x-hidden" type="file" />
                                             </div>
